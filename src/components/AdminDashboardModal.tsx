            ...
            <div className="space-y-6">
              ...
              <div className="p-4 sm:p-5 bg-white border border-red-200 rounded-lg space-y-3">
                <h4 className="text-sm font-black uppercase tracking-wider text-red-700">
                  {isArabic ? 'منطقة الخطر: استعادة البيانات الافتراضية الأولية' : 'Danger Zone: Reset Demo Data'}
                </h4>
                <p className="text-xs text-neutral-600 leading-relaxed">
                  {isArabic
                    ? 'يمكنك استعادة المنتجات والأقسام والأطقم الأصلية في أي وقت إذا أردت الرجوع للبيانات الافتراضية الأولية.'
                    : 'Restore the original default products, categories, and bundles.'}
                </p>
                <button
                  type="button"
                  onClick={() => {
                    if (
                      window.confirm(
                        isArabic
                          ? 'هل أنت متأكد من استعادة كافة المنتجات والأقسام الافتراضية؟ سيتم مسح التعديلات المحلية.'
                          : 'Are you sure you want to reset all products and categories to initial default demo data?'
                      )
                    ) {
                      onResetDefaults();
                      showNotification(isArabic ? 'تمت استعادة البيانات الافتراضية بنجاح' : 'Defaults restored');
                    }
                  }}
                ...
                >
                  ...
                  <span>{isArabic ? 'استعادة البيانات الافتراضية للمتجر' : 'Reset to Default Catalog'}</span>
                </button>
              </div>
            </div>
          )}
